...
import { Divider, List, ListItemButton, ListItemText, Button, Radio } from "@mui/material";
      ...
      <Grid container spacing={2}>
        ...
        <Grid item xs={12} md={8} sx={{ flexGrow: 1, display: "flex", flexWrap: "wrap" }}>
          <Item>
            ...
            <Box
              component="img"
              src={`data:image/jpeg;base64,${listQuestion[selectedIndex].src}`}
